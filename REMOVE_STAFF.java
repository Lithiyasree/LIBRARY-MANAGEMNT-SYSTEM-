...
public class REMOVE_STAFF extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ENTER STAFF ID OR STAFF DETAILS");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            query = "DELETE FROM STAFFS WHERE STAFF_ID=" + numberInput;
        } catch (NumberFormatException e) {
            query = "DELETE FROM STAFFS WHERE NAME='" + input + "' OR EMAIL='"+input+"' OR CONTACT='" + input + "'";
        }
        ...
        try{
            ...
            if(rows>0){
                JOptionPane.showMessageDialog(this,"STAFF RECORD REMOVED SUCCESSFULLY");
            }
            else{
                JOptionPane.showMessageDialog(this,"NO SUCH STAFF RECORD AVAILABLE");
            }
            stmt.close();
        }
        catch(Exception e){
