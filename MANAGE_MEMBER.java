 ...
 * Click nbfs0://nbhost/SystemFileSystem/Templates/GUIForms/JFrame.java to edit this template
 */
 ...
 * @author rlith
 */
public class MANAGE_MEMBER extends javax.swing.JFrame {
    ...
    /**
     * Creates new form MANAGE_MEMBER
     */
    public MANAGE_MEMBER() {
        initComponents();
        
        Model = (DefaultTableModel) MEMBER.getModel(); // Get Table Model
    ...
    private void updateDatabase(int row) {
        String updateQuery = "UPDATE USER SET USER_NAME=?, USER_ID=?, EMAIL=?, MOBILE=?, QUALIFICATION=?,DESIGNATION=? WHERE ID=? AND  USER_TYPE='MEMBER'";

        try (Connection conn = DriverManager.getConnection(url, user, pass);
             PreparedStatement pstmt = conn.prepareStatement(updateQuery)) {

            int id = (int) Model.getValueAt(row, 0); // ID column (Primary Key)
            String member_id = (String) Model.getValueAt(row, 1);
            ...
            String qualification = (String) Model.getValueAt(row, 5);
            String designation = (String) Model.getValueAt(row, 6);
    ...
    private void initComponents() {
        ...
        MEMBER.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "MEMBER ID", "MEMBER NAME", "EMAIL", "MOBILE", "QUALIFICATION", "DESIGNATION"
            }
        ) {
        ...
        FILTERS.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "USER_ID", "USER_NAME", "EMAIL", "MOBILE", "QUALIFICATION", "DESIGNATION", " ", " ", " ", " ", " ", " ", " " }));
        ...
        jLabel1.setText("MANAGE MEMBER DETAILS");
    ...
    DefaultTableModel model = (DefaultTableModel) MEMBER.getModel();
    ...
    String query;
    if (applyFilter) {
        query = "SELECT ID, USER_ID, USER_NAME, EMAIL, MOBILE, QUALIFICATION, DESIGNATION " +
                "FROM USER WHERE " + selectedFilter + " LIKE ? AND USER_TYPE = 'MEMBER'";
    } else {
        query = "SELECT ID, USER_ID, USER_NAME, EMAIL, MOBILE, QUALIFICATION, DESIGNATION FROM USER WHERE USER_TYPE ='MEMBER'";
    }
    ...
    private void UPDATE_DATABASEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UPDATE_DATABASEActionPerformed
        ...
        int selectedRow = MEMBER.getSelectedRow(); // Get selected row
    ...
    private void REMOVEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_REMOVEActionPerformed
        ...
        int selectedRow = MEMBER.getSelectedRow();
        if (selectedRow == -1) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MANAGE_MEMBER.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MANAGE_MEMBER().setVisible(true);
            }
        });
    }
